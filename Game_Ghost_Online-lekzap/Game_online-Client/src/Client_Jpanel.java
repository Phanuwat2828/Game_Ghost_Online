...
public class Client_Jpanel extends JPanel {
    ...
    Image Boss_Zombie = Toolkit.getDefaultToolkit()
            .createImage(File.separator + path_gif + File.separator + "Boss_Zombie.gif");
    ...
    int[] axisX, axisY, bossX, bossY, speedX, Health, Max_HP, Percent_HP, Damage, SpeedBoss, Max_HP_boss, Health_boss,
            Percent_HP_boss;
                    ...
                    : Percent_HP_boss[i] >= 60 ? Color.YELLOW
                            : Percent_HP_boss[i] >= 40 ? new Color(255, 165, 0)
                                    : Percent_HP_boss[i] >= 30 ? new Color(255, 69, 0)
                                            : Percent_HP_boss[i] >= 20 ? Color.RED : new Color(139, 0, 0));
